...
Gantt.plugin(function(t) {
    ! function(t, e) {
        "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define("ext/dhtmlxgantt_keyboard_navigation", [], e) : "object" == typeof exports ? exports["ext/dhtmlxgantt_keyboard_navigation"] = e() : t["ext/dhtmlxgantt_keyboard_navigation"] = e()
    }(window, function() {
        return function(t) {
            var e = {};
                ...
                function n(t) {
                    ...
                    if (t.getBoundingClientRect) {
                        var a = t.getBoundingClientRect(),
                            ...
                            d = window.pageYOffset || s.scrollTop || r.scrollTop,
                            l = window.pageXOffset || s.scrollLeft || r.scrollLeft,
                            c = s.clientTop || r.clientTop || 0,
                            u = s.clientLeft || r.clientLeft || 0;
                        e = a.top + d - c, n = a.left + l - u, o = document.body.offsetWidth - a.right, i = document.body.offsetHeight - a.bottom
                    } else {
                        for (; t;) e += parseInt(t.offsetTop, 10), n += parseInt(t.offsetLeft, 10), t = t.offsetParent;
                        o = document.body.offsetWidth - t.offsetWidth - n, i = document.body.offsetHeight - t.offsetHeight - e
                    }
                    return {
                        y: Math.round(e),
                        x: Math.round(n),
                ...
                t.exports = {
                    ...
                    getFocusableNodes: function(t) {
                        for (var e = t.querySelectorAll(["a[href]", "area[href]", "input", "select", "textarea", "button", "iframe", "object", "embed", "[tabindex]", "[contenteditable]"].join(", ")), n = Array.prototype.slice.call(e, 0), s = 0; s < n.length; s++) {
                            var d = n[s];
                            (i(d) || r(d) || a(d)) && o(d) || (n.splice(s, 1), s--)
                        }
                        return n
                    },
                    ...
                    getChildNodes: function(t, e) {
                        for (var n = t.childNodes, o = n.length, i = [], a = 0; a < o; a++) {
                            var r = n[a];
                            r.className && -1 !== r.className.indexOf(e) && i.push(r)
                        }
                        return i
                    },
                    toNode: function(t) {
                    ...
                    locateClassName: function(t, e, n) {
                        ...
                        for (void 0 === n && (n = !0); o;) {
                            if (i = s(o)) {
                                ...
                                if (a >= 0) {
                                    if (!n) return o;
                                    var r = 0 === a || !c(i.charAt(a - 1)),
                                        d = a + e.length >= i.length || !c(i.charAt(a + e.length));
                                    if (r && d) return o
                                }
                            }
                            o = o.parentNode
                    ...
                    getRelativeEventPosition: function(t, e) {
                        var o = document.documentElement,
                            i = n(e);
                        return {
                            x: t.clientX + o.scrollLeft - o.clientLeft - i.x + e.scrollLeft,
                            y: t.clientY + o.scrollTop - o.clientTop - i.y + e.scrollTop
                        }
                    },
                ...
                t.exports = function(t) {
                    t.$keyboardNavigation.dispatcher = {
                        ...
                        fromDomElement: function(e) {
                            for (var n = [t.$keyboardNavigation.TaskRow, t.$keyboardNavigation.TaskCell, t.$keyboardNavigation.HeaderCell], o = 0; o < n.length; o++)
                                if (n[o].prototype.fromDomElement) {
                                    var i = n[o].prototype.fromDomElement(e);
                                    if (i) return i
                                } return null
                        },
                        ...
                        keyDownHandler: function(e) {
                            if (!t.$keyboardNavigation.isModal() && this.isEnabled() && !(e = e || window.event).defaultPrevented) {
                                var n = this.globalNode,
                                    o = t.$keyboardNavigation.shortcuts.getCommandFromEvent(e),
                                    i = this.getActiveNode();
                                !1 !== t.$keyboardNavigation.facade.callEvent("onKeyDown", [o, e]) && (i ? i.findHandler(o) ? i.doAction(o, e) : n.findHandler(o) && n.doAction(o, e) : this.setDefaultNode())
                            }
                        },
                        _timeout: null,
            ...
            247: function(t, e) {
                t.exports = function(t) {
                    ! function() {
                        ...
                        function i(n) {
                            t.eventRemove(n, "keydown", r), t.event(n, "keydown", r), e.push(n)
                        }

                        function a() {
                            var n = e.pop();
                            n && t.eventRemove(n, "keydown", r), o()
                        }

                        function r(n) {
                            var o = (n = n || window.event).currentTarget;
                            (function(t) {
                                return t == e[e.length - 1]
                            })(o) && t.$keyboardNavigation.trapFocus(o, n)
                        }
            ...
            248: function(t, e, n) {
                t.exports = function(t) {
                    ...
                    t.$keyboardNavigation.TaskCell = function(e, n) {
                        if (!e) {
                            var o = t.getChildren(t.config.root_id);
                            o[0] && (e = o[0])
                        }
                        ...
                        fallback: function() {
                            ...
                            if (e instanceof t.$keyboardNavigation.TaskRow) {
                                for (var o = t.getGridColumns(), i = this.columnIndex; i >= 0 && !o[i];) i--;
                                o[i] && (n = new t.$keyboardNavigation.TaskCell(e.taskId, i))
                            }
                            return n
                        },
                        fromDomElement: function(n) {
                            ...
                            if (t.isTaskExists(o)) {
                                ...
                                return a && (i = 1 * a.getAttribute("data-column-index")), new t.$keyboardNavigation.TaskCell(o, i)
                            }
                            return null
                        },
                        getNode: function() {
                    ...
                    t.$keyboardNavigation.TaskRow = function(e) {
                        ...
                        fallback: function() {
                            ...
                            if (t.getTaskByIndex(this.index - 1)) n = this.index - 1;
                                ...
                                for (var o = this.index; o >= 0;) {
                                    if (t.getTaskByIndex(o)) {
                                        n = o;
                                        break
                                    }
                                    o--
                        ...
                        focus: function(e) {
                            if (!e) {
                                var n, o, i = t.getTaskPosition(t.getTask(this.taskId)),
                                    a = t.config.row_height,
                                    r = t.getScrollState();
                                n = t.$task ? t.$task.offsetWidth : r.inner_width, o = t.$grid_data || t.$task_data ? (t.$grid_data || t.$task_data).offsetHeight : r.inner_height, i.top < r.y || i.top + a > r.y + o ? t.scrollTo(null, i.top - 5 * a) : t.config.show_chart && (i.left < r.x || i.left > r.x + n) && t.scrollTo(i.left - t.config.task_scroll_offset)
                            }
                        ...
                        keys: {
                            ...
                            down: function() {
                                var e = t.getNext(this.taskId);
                                console.log(t.getNext(this.taskId));
            ...
            250: function(t, e, n) {
                t.exports = function(t) {
                    ...
                    t.$keyboardNavigation.HeaderCell = function(t) {
                        ...
                        fromDomElement: function(n) {
                            var o = e.locateClassName(n, "gantt_grid_head_cell");
                            if (o) {
                                for (var i = 0; o && o.previousSibling;) o = o.previousSibling, i += 1;
                                return new t.$keyboardNavigation.HeaderCell(i)
                            }
                            return null
                        },
                        getNode: function() {
                        ...
                        focus: function() {
                            ...
                            if (e) {
                                ...
                                !1 !== n.callEvent("onBeforeFocus", [e]) && e && (e.setAttribute("tabindex", "-1"), e.$eventAttached || (e.$eventAttached = !0, t.event(e, "focus", function(t) {
                                    return (t = t || event).preventDefault(), !1
                    ...
                    t.$keyboardNavigation.GanttNode = function() {}, t.$keyboardNavigation.GanttNode.prototype = t._compose(t.$keyboardNavigation.EventHandler, {
                        ...
                        scrollHorizontal: function(e) {
                            var n = t.dateFromPos(t.getScrollState().x),
                                o = t.getScale(),
                                i = e < 0 ? -o.step : o.step;
                            n = t.date.add(n, i, o.unit), t.scrollTo(t.posFromDate(n))
                        },
                        scrollVertical: function(e) {
                            var n = t.getScrollState().y,
                                o = t.config.row_height;
                            t.scrollTo(null, n + (e < 0 ? -1 : 1) * o)
                        },
                        keys: {
                            "alt+left": function(t) {
                ...
                t.exports = function(t) {
                    ! function() {
                        ...
                        t.$keyboardNavigation.getFocusableNodes = e.getFocusableNodes, t.$keyboardNavigation.trapFocus = function(e, n) {
                            ...
                            for (var o = t.$keyboardNavigation.getFocusableNodes(e), i = document.activeElement, a = -1, r = 0; r < o.length; r++)
                                if (o[r] == i) {
                                    a = r;
                                    break
                                } if (n.shiftKey) {
                                ...
                                var d = o[0];
                                if (d) return d.focus(), n.preventDefault(), !0
                            }
                            return !1
                        }
                    }()
                ...
                t.exports = function(t) {
                    t.$keyboardNavigation.EventHandler = {
                        ...
                        doAction: function(e, n) {
                            var o = this.findHandler(e);
                            if (o) {
                                if (!1 === t.$keyboardNavigation.facade.callEvent("onBeforeAction", [e, n])) return;
                                o.call(this, n), n.preventDefault ? n.preventDefault() : n.returnValue = !1
                            }
                        },
                        bind: function(e, n) {
                            this._handlers || (this._handlers = {});
                            for (var o = t.$keyboardNavigation.shortcuts, i = o.parse(e), a = 0; a < i.length; a++) this._handlers[o.getHash(i[a])] = n
                        },
                        unbind: function(e) {
                            for (var n = t.$keyboardNavigation.shortcuts, o = n.parse(e), i = 0; i < o.length; i++) this._handlers[n.getHash(o[i])] && delete this._handlers[n.getHash(o[i])]
                        },
                        bindAll: function(t) {
            ...
            255: function(t, e) {
                t.exports = function(t) {
                    t.$keyboardNavigation.shortcuts = {
                        ...
                        parse: function(t) {
                            for (var e = [], n = this.getExpressions(this.trim(t)), o = 0; o < n.length; o++) {
                                for (var i = this.getWords(n[o]), a = this.createCommand(), r = 0; r < i.length; r++) this.commandKeys[i[r]] ? a.modifiers[i[r]] = !0 : this.specialKeys[i[r]] ? a.keyCode = this.specialKeys[i[r]] : a.keyCode = i[r].charCodeAt(0);
                                e.push(a)
                            }
                            return e
                        },
                    ...
                    ! function(t) {
                        t.config.keyboard_navigation = !0, t.config.keyboard_navigation_cells = !1, t.$keyboardNavigation = {}, t._compose = function() {
                            for (var t = Array.prototype.slice.call(arguments, 0), e = {}, n = 0; n < t.length; n++) {
                                var o = t[n];
                                for (var i in "function" == typeof o && (o = new o), o) e[i] = o[i]
                            }
                            return e
                        }, o(255)(t), o(254)(t), o(253)(t), o(252)(t), o(251)(t), o(250)(t), o(249)(t), o(248)(t), o(247)(t), o(246)(t);
                        var n = o(1);
                        ! function() {
                            var o = t.$keyboardNavigation.dispatcher;
                            o.isTaskFocused = function(e) {
                                var n = o.activeNode;
                                return (n instanceof t.$keyboardNavigation.TaskRow || n instanceof t.$keyboardNavigation.TaskCell) && n.taskId == e
                            };
                            var i = function(e) {
                                    if (t.config.keyboard_navigation) return o.keyDownHandler(e)
                                },
                                a = function(e) {
                                    if (o.$preventDefault) return e.preventDefault(), t.$container.blur(), !1;
                                    o.awaitsFocus() || o.focusGlobalNode()
                                },
                                r = function() {
                                    if (o.isEnabled()) {
                                        var t = o.getActiveNode();
                                        if (t) {
                                            var e, n, i = t.getNode();
                                            i && i.parentNode && (e = i.parentNode.scrollTop, n = i.parentNode.scrollLeft), t.focus(!0), i && i.parentNode && (i.parentNode.scrollTop = e, i.parentNode.scrollLeft = n)
                                        }
                                    }
                                };
                            ...
                            function s(e) {
                                ...
                                var i, a = o.fromDomElement(e);
                                a && (o.activeNode instanceof t.$keyboardNavigation.TaskCell && n.isChildOf(e.target, t.$task) && (a = new t.$keyboardNavigation.TaskCell(a.taskId, o.activeNode.columnIndex)), i = a), i ? o.isEnabled() ? o.delay(function() {
                                    o.setActiveNode(i)
                                }) : o.activeNode = i : (o.$preventDefault = !0, setTimeout(function() {
                                    o.$preventDefault = !1
                                }, 300))
                            }
                            t.attachEvent("onDataRender", function() {
                                t.config.keyboard_navigation && r()
                            }), t.attachEvent("onGanttRender", function() {
                                t.eventRemove(document, "keydown", i), t.eventRemove(t.$container, "focus", a), t.eventRemove(t.$container, "mousedown", s), t.config.keyboard_navigation ? (t.event(document, "keydown", i), t.event(t.$container, "focus", a), t.event(t.$container, "mousedown", s), t.$container.setAttribute("tabindex", "0")) : t.$container.removeAttribute("tabindex")
                            });
                            var d = t.attachEvent("onGanttReady", function() {
                                if (t.detachEvent(d), t.$data.tasksStore.attachEvent("onStoreUpdated", function(e) {
                                        if (t.config.keyboard_navigation && o.isEnabled()) {
                                            var n = o.getActiveNode();
                                            n && n.taskId == e && r()
                                        }
                                    }), t._smart_render) {
                                    var e = t._smart_render._redrawTasks;
                                    t._smart_render._redrawTasks = function(n, i) {
                                        if (t.config.keyboard_navigation && o.isEnabled()) {
                                            var a = o.getActiveNode();
                                            if (a && void 0 !== a.taskId) {
                                                for (var r = !1, s = 0; s < i.length; s++)
                                                    if (i[s].id == a.taskId && i[s].start_date) {
                                                        r = !0;
                                                        break
                                                    } r || i.push(t.getTask(a.taskId))
                                            }
                                        }
                            ...
                            t.attachEvent("onAfterTaskAdd", function(e, n) {
                                if (!t.config.keyboard_navigation) return !0;
                                if (o.isEnabled()) {
                                    var i = 0,
                                        a = o.activeNode;
                                    a instanceof t.$keyboardNavigation.TaskCell && (i = a.columnIndex);
                                    var r = t.config.keyboard_navigation_cells ? t.$keyboardNavigation.TaskCell : t.$keyboardNavigation.TaskRow;
                                    o.setActiveNode(new r(e, i))
                                }
                            }), t.attachEvent("onTaskIdChange", function(e, n) {
                                if (!t.config.keyboard_navigation) return !0;
                                var i = o.activeNode;
                                return o.isTaskFocused(e) && (i.taskId = n), !0
                            });
                            var l = setInterval(function() {
                                if (t.config.keyboard_navigation) {
                                    var e, n = function() {
                                        ...
                                        i = t.$container;
                                    if (!n || t._locate_css(n, "gantt_cal_quick_info")) e = !1;
                                    else {
                                        for (; n != i && n;) n = n.parentNode;
                                        e = n == i
                                    }
                                    e && !o.isEnabled() ? o.enable() : !e && o.isEnabled() && o.disable()
                                }
                            }, 500);
                            ...
                            function u(e) {
                                for (var n = t.getGridColumns(), o = 0; o < n.length; o++)
                            ...
                            e(f), t.mixin(f, {
                                addShortcut: function(t, e, n) {
                                    var o = c(n);
                                    o && o.prototype.bind(t, e)
                                },
                                getShortcutHandler: function(e, n) {
                                    var o = t.$keyboardNavigation.shortcuts.parse(e);
                                    if (o.length) return this.getCommandHandler(o[0], n)
                                },
                                ...
                                focus: function(t) {
                                    var e, n = t ? t.type : null,
                                        i = c(n);
                                    switch (n) {
                                        case "taskCell":
                                            e = new i(t.id, u(t.column));
                                            break;
                                        case "taskRow":
                                            e = new i(t.id);
                                            break;
                                    ...
                                    o.delay(function() {
                                        e ? o.setActiveNode(e) : (o.enable(), o.getActiveNode() ? o.awaitsFocus() || o.enable() : o.setDefaultNode())
                                    })
                                },
                                getActiveNode: function() {
                                    if (o.isEnabled()) {
                                        var e = o.getActiveNode(),
                                            n = function(e) {
                                        ...
                                        switch (n) {
                                            case "taskCell":
                                                return {
                                                    type: "taskCell", id: e.taskId, column: i[e.columnIndex].name
                                                };
                                            case "taskRow":
                                                return {
                                            ...
                                            case "headerCell":
                                                return {
                                                    type: "headerCell", column: i[e.index].name
                                                }
                                        }
                                    }
                                    return null
                                }
                            }), t.$keyboardNavigation.facade = f, t.ext.keyboardNavigation = f, t.focus = function() {
                                f.focus()
                            }, t.addShortcut = f.addShortcut, t.getShortcutHandler = f.getShortcutHandler, t.removeShortcut = f.removeShortcut
                        }()
                    }(t)
                }()
            },
            4: function(t, e) {
                ...
                t.exports = function(t) {
                    var e = new n;
                    t.attachEvent = function(t, n, i) {
                        return t = "ev_" + t.toLowerCase(), e[t] || (e[t] = o(i || this)), t + ":" + e[t].addEvent(n)
                    }, t.attachAll = function(t, e) {
                        this.attachEvent("listen_all", t, e)
                    }, t.callEvent = function(t, n, o) {
                        if (e._silent_mode) return !0;
                        var i = "ev_" + t.toLowerCase();
                        return e.ev_listen_all && e.ev_listen_all.apply(o || this, [t].concat(n)), !e[i] || e[i].apply(o || this, n)
